...
void Widget::Login()  //登录槽
{
    ...
    else
    {
            if(flag == 1)
            {
                if (Accountdb.login_check(namestring,passwordstring))
                {
