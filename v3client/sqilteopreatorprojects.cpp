...
std::vector<int> sqilteOpreatorProjects::searchProjectName(QString projectName)
{
    ...
    nowObject.insert("messageType", 18);
...
{
    QJsonObject nowObject;
    nowObject.insert("messageType", 19);
...
std::vector<int> sqilteOpreatorProjects::searchProjectFather(int projectFather)
{
    ...
    QJsonObject nowObject;
    nowObject.insert("messageType", 20);
    nowObject.insert("projectFather",projectFather);
    ...
    QJsonParseError jsonError;
    QJsonDocument doucment = QJsonDocument::fromJson(ansArray, &jsonError);
    QJsonObject ansobject = doucment.object();
    QJsonArray productArrayList = ansobject.value("anslist").toArray();
    std::vector<int> w_list;
    for(int i = 0;i < productArrayList.size() ; i++)
...
Projects_books sqilteOpreatorProjects::searchProjectInfo(int projectID)
{
    ...
    QJsonObject nowObject;
    nowObject.insert("messageType", 21);
    ...
    QJsonObject ansobject = doucment.object();
    Projects_books ans;
    ans.id = ansobject.value("id").toInt();
    ans.Name = ansobject.value("Name").toString();
    ans.infor = ansobject.value("infor").toString();
    ans.prise = ansobject.value("prise").toInt();
    ans.type = ansobject.value("type").toInt();
    ans.number = ansobject.value("number").toInt();
    ans.discount = ansobject.value("discount").toInt();
    ans.father = ansobject.value("father").toInt();
    return ans;
...
{
    QJsonObject nowObject;
    nowObject.insert("messageType", 22);
...
{
    QJsonObject nowObject;
    nowObject.insert("messageType", 23);
    nowObject.insert("id",Data.id);
    nowObject.insert("Name" ,Data.Name.toStdString().c_str());
    nowObject.insert("infor" ,Data.infor.toStdString().c_str());
    nowObject.insert("prise",Data.prise);
    nowObject.insert("type",Data.type);
    nowObject.insert("number",Data.number);
    nowObject.insert("discount",Data.discount);
    nowObject.insert("father",Data.father);
...
{
    QJsonObject nowObject;
    nowObject.insert("messageType", 24);
    nowObject.insert("id",Data.id);
    nowObject.insert("Name" ,Data.Name.toStdString().c_str());
    nowObject.insert("infor" ,Data.infor.toStdString().c_str());
    nowObject.insert("prise",Data.prise);
...
{
    QJsonObject nowObject;
    nowObject.insert("messageType", 25);
    nowObject.insert("id",Data.id);
    nowObject.insert("Name" ,Data.Name.toStdString().c_str());
    nowObject.insert("infor" ,Data.infor.toStdString().c_str());
    nowObject.insert("prise",Data.prise);
    ...
    nowObject.insert("discount",Data.discount);
    nowObject.insert("father",Data.father);
    qDebug()<<QString("%1").arg(Data.discount);
...
bool sqilteOpreatorProjects::modifyprojectNumber(int nowProjectID,int Number)
{
    ...
    QJsonObject nowObject;
    nowObject.insert("messageType", 26);
    nowObject.insert("id",nowProjectID);
    nowObject.insert("number",Number);
...
bool sqilteOpreatorProjects::deleteData(int id)
{
    ...
    QJsonObject nowObject;
    nowObject.insert("messageType", 27);
